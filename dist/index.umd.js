(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MicroLottieReact = {}, global.React));
...
- Memory Usage: ${(metrics.memoryUsage / 1024 / 1024).toFixed(2)}MB
     ...
     */
    const LottiePlayer = require$$0.forwardRef(({ src, autoplay = true, loop = true, renderer = "canvas", speed = 1, direction = 1, segments, style, className, onComplete, onProgress, onError, onLoad, preserveAspectRatio: _preserveAspectRatio = "xMidYMid meet", // TODO: Apply to SVG renderer
    rendererSettings = {}, }, ref) => {
        const containerRef = require$$0.useRef(null);
        const animationRef = require$$0.useRef(null);
    ...
    function useLottie(options) {
        ...
        const animationRef = require$$0.useRef(null);
        const [isLoaded, setIsLoaded] = require$$0.useState(false);
        const [isPlaying, setIsPlaying] = require$$0.useState(false);
        const [isPaused, setIsPaused] = require$$0.useState(false);
        const [isStopped, setIsStopped] = require$$0.useState(true);
        const [progress, setProgress] = require$$0.useState(0);
        const [currentFrame, setCurrentFrame] = require$$0.useState(0);
        const [totalFrames, setTotalFrames] = require$$0.useState(0);
        const [duration, setDuration] = require$$0.useState(0);
        const [frameRate, setFrameRate] = require$$0.useState(30);
        const [animationData, setAnimationData] = require$$0.useState(null);
        const [error, setError] = require$$0.useState(null);
        ...
        const play = require$$0.useCallback(() => {
            if (animationRef.current) {
                animationRef.current.play();
                setIsPlaying(true);
                setIsPaused(false);
        ...
        const pause = require$$0.useCallback(() => {
            if (animationRef.current) {
                animationRef.current.pause();
                setIsPlaying(false);
                setIsPaused(true);
        ...
        const seek = require$$0.useCallback((newProgress) => {
            if (animationRef.current) {
        ...
        const setSpeedCallback = require$$0.useCallback((newSpeed) => {
            if (animationRef.current) {
                animationRef.current.setSpeed(newSpeed);
            }
        }, []);
        const setDirectionCallback = require$$0.useCallback((newDirection) => {
            if (animationRef.current) {
                animationRef.current.setDirection(newDirection);
            }
        }, []);
        const goToAndPlay = require$$0.useCallback((frame) => {
            if (animationRef.current) {
        ...
        const goToAndStop = require$$0.useCallback((frame) => {
            if (animationRef.current) {
        ...
        const playSegments = require$$0.useCallback((newSegments, forceFlag = false) => {
            if (animationRef.current) {
        ...
        const setSubframe = require$$0.useCallback((useSubFrames) => {
            if (animationRef.current) {
    ...
    function useScrollLottie(src, options = {}) {
        const containerRef = require$$0.useRef(null);
        const [scrollProgress, setScrollProgress] = require$$0.useState(0);
        const lottie = useLottie({
            container: containerRef,
            src,
            autoplay: false,
    ...
    exports.LottieParser = LottieParser;
    ...
    exports.useHoverLottie = useHoverLottie;
    exports.useLazyLottie = useLazyLottie;
    exports.useLottie = useLottie;
    exports.useScrollLottie = useScrollLottie;
    exports.useSimpleLottie = useSimpleLottie;
